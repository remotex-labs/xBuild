 ...
 * - When count reaches zero, the language service is cleaned up automatically
 *
...
export class TypescriptService {
    ...
    check(): Array<DiagnosticsInterface> {
     ...
     * - Located in `node_modules` directory (third-party dependencies)
    ...
    private parseConfig(): ParsedCommandLine {
        ...
        config.options = {
            ...config.options,
            baseUrl: config.options?.baseUrl ?? process.cwd(),
