...
export class LanguageHostService implements ts.LanguageServiceHost {
    ...
    /**
     * Updates file snapshot in cache and returns current state.
     *
    ...
    /**
     * Returns current working directory used as resolution base.
     *
     ...
     * @returns resolution result (success + failed lookups)
     *
     * @since 2.0.0
     */
